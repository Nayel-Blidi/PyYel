...
class SegmentationDeeplabV3(ModelsAbstract):
    ...
    def __init__(self, name:str=None, version="ResNet50", **kwargs) -> None:
        """
        Args
        ----
    ...
    def sample_batch(self, subdataset_name, transform:transforms.Compose=None, test_size=0.25, **kwargs):
        """
